	...
	<div class="col-md-8">
		<nav aria-label="breadcrumb">
  			<ol class="breadcrumb" style="background-color: white;">
    			...
    			<li class="breadcrumb-item active" aria-current="page">La petite enfance</li>
  			</ol>
		</nav>
		<h1>La petite enfance</h1><br>
		<img class="img-fluid" src="img/petite-enfance.jpg"> <br><br><br><br>
		

<div class="row">
	<div class="col-md-9">
			<h5>Inscrire son enfant en crèche</h5>
			<p>Détails des pièces et conditions d'admission</p><br><br><br><br><br><br><br>
			<h5>Etablissement et services d'accueil</h5>
			<p>Liste des établissements municipaux composant le Village de la petite enfance : crèche collective, crèche familiale, halte-garderie, jardin d'enfants, multi accueil et Relais Assistantes Maternelles.</p> <br><br><br><br>
			<h5>Les autres modes d’accueil</h5>
			<p>Les crèches privés et autres structures d'accueil.</p> <br><br><br><br>
			<h5>Tarifs des prestations & aides financières pour la garde d’enfant</h5>
			<p>Barème des tarifs des prestations et aides financières possibles.</p><br><br><br>
		
		</div>
		<div class="col-md-3">
				<img class = "img-fluid" src="img/creche.jpg" style="height: 200px">
		</div>
...
<?php
		...
		if(isset($_POST['inscrire'])){
			$controler->insertPrestation01($idfamille); //On inscrit l'utilisateur à la prestation 
